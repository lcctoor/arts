...
# 教程 ([查看美化版](https://lcctoor.github.io/arts/arts/coolmongo) 👈)
...
from coolmongo import ORM, mc, mf, mo
```
...
【增、删、改、查】的同步方法名称分别为：insert、delete、update、find 。

对应的异步方法名称为各同步方法名前加 `a` ，即：ainsert、adelete、aupdate、afind 。
